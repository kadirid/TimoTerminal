...
class ProjectPrefService(
    ...
    fun getString(p0: ProjectPreferenceKeys, p1: String): String {
        return sharedPreferences.getString(p0.name, p1) ?: p1
    }
    ...
    fun saveProjectTimeTrackSetting(obj: JSONObject): ProjectTimeTrackSetting {
        ...
        editor.putBoolean(
            ProjectPreferenceKeys.PROJECT_ACTIVITY_TYPE_MATRIX.name,
            activityTypeMatrix
        )
        ...
        editor.putBoolean(
            ProjectPreferenceKeys.PROJECT_PERFORMANCE_LOCATION.name,
            performanceLocation
        )
    ...
    fun getProjectTimeTrackSetting(force: Boolean?): ProjectTimeTrackSetting {
        ...
        return ProjectTimeTrackSetting(
            ...
            getString(
                ProjectPreferenceKeys.PROJECT_FIELD_ORDER,
                ProjectTimeTrackSetting.DEFAULT_FIELD_ORDER
            )
        )
    }
